...
public class ThursdayAdapter extends RecyclerView.Adapter<ThursdayAdapter.ViewHolder>   {
    ...
    public ThursdayAdapter(Context context, List<ScheduleEntity> schedules) {
            this.context = context;
            this.schedules = schedules;
            }

    public ThursdayAdapter() {
            }

    @NonNull
    @Override
    public ThursdayAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view= LayoutInflater.from(context.getApplicationContext())
            .inflate(R.layout.recyclerview_schedule_display, parent, false);
            ThursdayAdapter.ViewHolder holder= new ThursdayAdapter.ViewHolder(view);
            return holder;
            }

    @Override
    public void onBindViewHolder(@NonNull ThursdayAdapter.ViewHolder holder, final int position) {
