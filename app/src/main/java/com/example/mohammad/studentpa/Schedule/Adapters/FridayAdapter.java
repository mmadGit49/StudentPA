...
public class FridayAdapter extends RecyclerView.Adapter<FridayAdapter.ViewHolder>   {
    ...
    public FridayAdapter(Context context, List<ScheduleEntity> schedules) {
        this.context = context;
        this.schedules = schedules;
    }

    public FridayAdapter() {
    }
    ...
    public FridayAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        FridayAdapter.ViewHolder holder= new FridayAdapter.ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull final FridayAdapter.ViewHolder holder, int position) {
