...
public class WednesdayAdapter extends RecyclerView.Adapter<WednesdayAdapter.ViewHolder>   {
    ...
    public WednesdayAdapter(Context context, List<ScheduleEntity> schedules) {
        this.context = context;
        this.schedules = schedules;
    }

    public WednesdayAdapter() {
    }

    @NonNull
    @Override
    public WednesdayAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context.getApplicationContext())
                .inflate(R.layout.recyclerview_schedule_display, parent, false);
        WednesdayAdapter.ViewHolder holder= new WednesdayAdapter.ViewHolder(view);
        return holder;
    }
