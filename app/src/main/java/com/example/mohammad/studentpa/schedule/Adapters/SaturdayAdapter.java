...
public class SaturdayAdapter extends RecyclerView.Adapter<SaturdayAdapter.ViewHolder>   {
    ...
    public SaturdayAdapter(Context context, List<ScheduleEntity> schedules) {
        this.context = context;
        this.schedules = schedules;
    }

    public SaturdayAdapter() {
    }

    @NonNull
    @Override
    public SaturdayAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context.getApplicationContext())
                .inflate(R.layout.recyclerview_schedule_display, parent, false);
        SaturdayAdapter.ViewHolder holder= new SaturdayAdapter.ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull final SaturdayAdapter.ViewHolder holder, int position) {
